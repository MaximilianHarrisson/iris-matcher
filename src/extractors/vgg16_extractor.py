...
class Vgg16Extractor:
    """https://docs.pytorch.org/vision/0.16/models/generated/torchvision.models.vgg16.html"""
    def __init__(self):
        resolved_device = 'cuda' if torch.cuda.is_available() else 'cpu'
        self.device = torch.device(resolved_device)

        self.feature_extractor, self.pooling = self._initialize_vgg16()
    ...
    def _initialize_vgg16(self) -> tuple:
